...
public class rich_media_stream_action_t {
    ...
    protected static long getCPtr(rich_media_stream_action_t rich_media_stream_action_t) {
        if (rich_media_stream_action_t == null) {
            return 0;
        }
        return rich_media_stream_action_t.swigCPtr;
    }
    ...
    public void setValue(rich_media_stream_action_t_value rich_media_stream_action_t_value) {
        PlayerJniJNI.rich_media_stream_action_t_value_set(this.swigCPtr, this, rich_media_stream_action_t_value.swigValue());
    }
    ...
    public rich_media_stream_action_t(rich_media_stream_action_t_value rich_media_stream_action_t_value) {
        this(PlayerJniJNI.new_rich_media_stream_action_t__SWIG_0(rich_media_stream_action_t_value.swigValue()), true);
    }
