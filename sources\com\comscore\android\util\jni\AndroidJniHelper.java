...
public class AndroidJniHelper extends JniComScoreHelper {
    ...
    public void onConfigurationChanged(int i) {
        if (i == 20301) {
            ...
            a();
        } else if (i == 20306 || (i == 20307 && !Analytics.getConfiguration().isVce())) {
            Vce.disable();
        }
    }
    ...
    public boolean subscribeToForegroundNotification() {
        Context context = this.a;
        if (!(context instanceof Application) || VERSION.SDK_INT < 14) {
            Logger.w("Unable to detect automatically if the application is in the foreground or in the background.");
            return false;
        }
        this.b = new BackgroundManager((Application) context);
        this.b.register();
        return true;
    }
