...
class b {
    ...
    public void n() {
        synchronized (this.a) {
            if (f()) {
                Log.w("Analytics", "Native tracking is already enabled. So calling nativeTrack is redundant.");
            } else {
                a("5");
                c(true);
            }
    ...
    public void o() {
        synchronized (this.a) {
            if (d()) {
                Log.w("Analytics", "Manual tracking cannot be used with auto-discovery methods: discoverAndTrackWebView and discoverAndTrackWebViewNames. Manual tracking is therefore disabled.");
            } else {
                a("3_4m");
                b(true);
                c(true);
