...
final class C1434jx {
    static String a(C1403ix ixVar, String str) {
    ...
    private static void a(C1403ix ixVar, StringBuilder sb, int i) {
        String str;
        boolean z;
        C1403ix ixVar2 = ixVar;
        StringBuilder sb2 = sb;
        int i2 = i;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet<>();
        Method[] declaredMethods = ixVar.getClass().getDeclaredMethods();
        ...
        for (String str2 : treeSet) {
            ...
            if (replaceFirst.endsWith(str4) && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals(str4)) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    a(sb2, i2, a(concat), C0197Cw.a(method2, (Object) ixVar2, new Object[0]));
                }
            }
            String str5 = "Map";
            if (replaceFirst.endsWith(str5) && !replaceFirst.equals(str5)) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    a(sb2, i2, a(concat2), C0197Cw.a(method3, (Object) ixVar2, new Object[0]));
                }
            }
            String str6 = "set";
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? str6.concat(valueOf5) : new String(str6))) != null) {
                ...
                if (method4 != null) {
                    Object a = C0197Cw.a(method4, (Object) ixVar2, new Object[0]);
                    if (method5 == null) {
                        if (!(a instanceof Boolean)) {
                            if (!(a instanceof Integer)) {
                                if (!(a instanceof Float)) {
                                    if (!(a instanceof Double)) {
                                        z = a instanceof String ? a.equals(str3) : a instanceof C0289Zv ? a.equals(C0289Zv.a) : !(a instanceof C1403ix) ? false : false;
                                        if (z) {
                                            z2 = false;
                                        }
                                    }
                        ...
                        z2 = ((Boolean) C0197Cw.a(method5, (Object) ixVar2, new Object[0])).booleanValue();
                    }
                    if (z2) {
        ...
        if (ixVar2 instanceof d) {
            Iterator c = ((d) ixVar2).zztj.c();
            if (c.hasNext()) {
                ((Entry) c.next()).getKey();
                throw new NoSuchMethodError();
            }
        }
        Rx rx = ((C0197Cw) ixVar2).zztc;
        if (rx != null) {
            rx.a(sb2, i2);
        }
    }
    ...
    static final void a(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(str2);
                sb.append(Jx.a(C0289Zv.a((String) obj)));
                sb.append('\"');
            } else if (obj instanceof C0289Zv) {
                sb.append(str2);
                sb.append(Jx.a((C0289Zv) obj));
                sb.append('\"');
            } else {
                String str3 = "}";
                String str4 = "\n";
                String str5 = " {";
                if (obj instanceof C0197Cw) {
                    sb.append(str5);
                    a((C0197Cw) obj, sb, i + 2);
                    sb.append(str4);
                    while (i2 < i) {
                        sb.append(' ');
                        i2++;
