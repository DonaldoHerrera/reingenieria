...
interface dd {
    ...
    void a(int i, Oa oa) throws IOException;

    <K, V> void a(int i, Vb<K, V> vb, Map<K, V> map) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, C0886rc rcVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<Oa> list) throws IOException;

    @Deprecated
    void a(int i, List<?> list, C0886rc rcVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, C0886rc rcVar) throws IOException;

    void b(int i, List<String> list) throws IOException;

    void b(int i, List<?> list, C0886rc rcVar) throws IOException;
