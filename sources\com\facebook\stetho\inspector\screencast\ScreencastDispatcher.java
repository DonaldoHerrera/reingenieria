...
public final class ScreencastDispatcher {
    ...
    private class BitmapFetchRunnable implements Runnable {
        ...
        public void run() {
            updateScreenBitmap();
            Handler access$500 = ScreencastDispatcher.this.mBackgroundHandler;
            EventDispatchRunnable access$300 = ScreencastDispatcher.this.mEventDispatchRunnable;
            access$300.withEndAction(this);
            access$500.post(access$300);
        }
    }
