...
final class C1495lw extends C1433jw {
    ...
    private C1495lw(byte[] bArr, int i2, int i3, boolean z) {
        super();
    ...
    public final String c() throws IOException {
        ...
        if (v > 0) {
            ...
            int i3 = this.j;
            if (v <= i2 - i3) {
                String str = new String(this.f, i3, v, C0209Gw.a);
                this.j += v;
                return str;
            }
        }
    ...
    public final C0289Zv l() throws IOException {
        ...
        if (v > 0) {
            ...
            int i3 = this.j;
            if (v <= i2 - i3) {
                C0289Zv a = C0289Zv.a(this.f, i3, v);
                this.j += v;
                return a;
            }
        }
