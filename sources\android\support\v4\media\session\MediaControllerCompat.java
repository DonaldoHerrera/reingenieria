...
public final class MediaControllerCompat {
    ...
    private static class MediaControllerExtraData extends a {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(f.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
