...
public class item_interaction_action_t {
    ...
    protected static long getCPtr(item_interaction_action_t item_interaction_action_t) {
        if (item_interaction_action_t == null) {
            return 0;
        }
        return item_interaction_action_t.swigCPtr;
    }
    ...
    public void setValue(item_interaction_action_t_value item_interaction_action_t_value) {
        PlayerJniJNI.item_interaction_action_t_value_set(this.swigCPtr, this, item_interaction_action_t_value.swigValue());
    }
    ...
    public item_interaction_action_t(item_interaction_action_t_value item_interaction_action_t_value) {
        this(PlayerJniJNI.new_item_interaction_action_t__SWIG_0(item_interaction_action_t_value.swigValue()), true);
    }
