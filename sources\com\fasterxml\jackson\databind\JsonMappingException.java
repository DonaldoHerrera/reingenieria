...
public class JsonMappingException extends JsonProcessingException {
    ...
    public static JsonMappingException fromUnexpectedIOE(IOException iOException) {
        return new JsonMappingException(null, String.format("Unexpected IOException (of type %s): %s", new Object[]{iOException.getClass().getName(), ClassUtil.exceptionMessage(iOException)}));
    }
