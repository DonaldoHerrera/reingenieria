...
final class Ob<T, R> implements C7118pQa<T, R> {
    final /* synthetic */ Jb a;
    final /* synthetic */ long b;
    final /* synthetic */ C3509cea c;

    Ob(Jb jb, long j, C3509cea cea) {
        this.a = jb;
        this.b = j;
        this.c = cea;
    }
    ...
    public final AudioPlaybackItem apply(b bVar) {
        C7471uYa.b(bVar, "it");
        AudioPlaybackItem a2 = AudioPlaybackItem.h.a(this.a.a(bVar.b()), this.a.a(bVar.a()), this.b, this.c.t(), new FadeOut(1000, 2000));
        Tma.a(a2, this.c.y());
        return a2;
    }
}
