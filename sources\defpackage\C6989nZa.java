...
public final class C6989nZa extends C6853lZa implements C6581hZa<Long> {
    ...
    public C6989nZa(long j, long j2) {
        super(j, j2, 1);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof C6989nZa) {
            if (!isEmpty() || !((C6989nZa) obj).isEmpty()) {
                C6989nZa nza = (C6989nZa) obj;
                if (getFirst() == nza.getFirst()) {
                }
            }
            return true;
        }
