...
public final class Xd {
    ...
    public Xd(Lc lc, Ica ica, C3700b bVar, Db db, HPa hPa) {
    ...
    private final Yca a(C3508cda cda) {
        ...
        return ((Boolean) b2).booleanValue() ? Yca.YOUR_TOP_TRACKS : Yca.USERS_TOP_TRACKS;
    }

    public final Wd a(C3508cda cda, SearchQuerySourceInfo searchQuerySourceInfo) {
        C7471uYa.b(cda, "user");
        Wd wd = new Wd(a(cda), this.c, this.d, searchQuerySourceInfo, cda, this.a, this.e);
        return wd;
    }
}
