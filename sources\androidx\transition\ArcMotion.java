...
public class ArcMotion extends PathMotion {
    ...
    public ArcMotion(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, X.j);
        XmlPullParser xmlPullParser = (XmlPullParser) attributeSet;
        c(C0286Za.a(obtainStyledAttributes, xmlPullParser, "minimumVerticalAngle", 1, 0.0f));
        b(C0286Za.a(obtainStyledAttributes, xmlPullParser, "minimumHorizontalAngle", 0, 0.0f));
        a(C0286Za.a(obtainStyledAttributes, xmlPullParser, "maximumAngle", 2, 70.0f));
