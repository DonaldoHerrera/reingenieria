...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1406j.ButtonBarLayout);
        this.a = obtainStyledAttributes.getBoolean(C1406j.ButtonBarLayout_allowStacking, true);
    ...
    private void setStacked(boolean z) {
        ...
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C1283f.spacer);
