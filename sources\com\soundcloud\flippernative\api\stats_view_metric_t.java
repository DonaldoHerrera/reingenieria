...
public class stats_view_metric_t {
    ...
    protected static long getCPtr(stats_view_metric_t stats_view_metric_t) {
        if (stats_view_metric_t == null) {
            return 0;
        }
        return stats_view_metric_t.swigCPtr;
    }
    ...
    public void setValue(stats_view_metric_t_value stats_view_metric_t_value) {
        PlayerJniJNI.stats_view_metric_t_value_set(this.swigCPtr, this, stats_view_metric_t_value.swigValue());
    }
    ...
    public stats_view_metric_t(stats_view_metric_t_value stats_view_metric_t_value) {
        this(PlayerJniJNI.new_stats_view_metric_t__SWIG_0(stats_view_metric_t_value.swigValue()), true);
    }
