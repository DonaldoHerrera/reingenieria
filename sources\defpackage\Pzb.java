...
class Pzb {
    ...
    public void a(C7030oAb oab, C6893mAb mab) throws IOException {
        int i = 0;
        long j = 0;
        byte b2 = 0;
        while (i < oab.f()) {
        ...
        if (b2 > 0) {
            mab.writeByte((int) (((long) (255 >>> b2)) | (j << (8 - b2))));
        }
    }

    /* access modifiers changed from: 0000 */
    public int a(C7030oAb oab) {
        long j = 0;
        for (int i = 0; i < oab.f(); i++) {
            j += (long) b[oab.a(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
