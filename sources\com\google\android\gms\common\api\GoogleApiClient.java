...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        private AbstractClientBuilder<? extends Oy, Ky> zace;
        ...
        public final GoogleApiClient build() {
            ...
            for (Api api2 : this.zabz.keySet()) {
                ...
                t2.put(api3.getClientKey(), buildClient);
            ...
            zaaw zaaw = new zaaw(this.mContext, new ReentrantLock(), this.zabj, buildClientSettings, this.zacd, this.zace, t, this.zacf, this.zacg, t2, this.zacb, zaaw.zaa(t2.values(), true), arrayList, false);
        ...
        public final ClientSettings buildClientSettings() {
            Ky ky = Ky.a;
            if (this.zabz.containsKey(Ly.g)) {
                ky = (Ky) this.zabz.get(Ly.g);
            }
            ClientSettings clientSettings = new ClientSettings(this.zax, this.zabr, this.zabx, this.zabt, this.zabu, this.zabv, this.zabw, ky, false);
