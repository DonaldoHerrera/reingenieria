...
public final class C5579aab<D, E, R> extends C7405tab<D, E, R> implements BZa<D, E, R> {
    private final b<a<D, E, R>> o;

    /* renamed from: aab$a */
    /* compiled from: KProperty2Impl.kt */
    public static final class a<D, E, R> extends d<R> implements defpackage.BZa.a<D, E, R> {
        private final C5579aab<D, E, R> h;

        public a(C5579aab<D, E, R> aab) {
            C7471uYa.b(aab, "property");
            this.h = aab;
        }
        ...
        public C5579aab<D, E, R> e() {
            return this.h;
        }
    }

    public C5579aab(N_a n_a, C7408tdb tdb) {
        C7471uYa.b(n_a, "container");
        C7471uYa.b(tdb, "descriptor");
        super(n_a, tdb);
        b<a<D, E, R>> a2 = C5300Sab.a((PXa<T>) new C5647bab<T>(this));
        C7471uYa.a((Object) a2, "ReflectProperties.lazy { Setter(this) }");
        this.o = a2;
    }

    public void b(D d, E e, R r) {
        c().a(d, e, r);
    }
