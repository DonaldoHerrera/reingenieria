...
public class audio_performance_audio_quality_mode_t {
    ...
    protected static long getCPtr(audio_performance_audio_quality_mode_t audio_performance_audio_quality_mode_t) {
        if (audio_performance_audio_quality_mode_t == null) {
            return 0;
        }
        return audio_performance_audio_quality_mode_t.swigCPtr;
    }
    ...
    public void setValue(audio_performance_audio_quality_mode_t_value audio_performance_audio_quality_mode_t_value) {
        PlayerJniJNI.audio_performance_audio_quality_mode_t_value_set(this.swigCPtr, this, audio_performance_audio_quality_mode_t_value.swigValue());
    }
    ...
    public audio_performance_audio_quality_mode_t(audio_performance_audio_quality_mode_t_value audio_performance_audio_quality_mode_t_value) {
        this(PlayerJniJNI.new_audio_performance_audio_quality_mode_t__SWIG_0(audio_performance_audio_quality_mode_t_value.swigValue()), true);
    }
