...
public class offline_sync_quality_t {
    ...
    protected static long getCPtr(offline_sync_quality_t offline_sync_quality_t) {
        if (offline_sync_quality_t == null) {
            return 0;
        }
        return offline_sync_quality_t.swigCPtr;
    }
    ...
    public void setValue(offline_sync_quality_t_value offline_sync_quality_t_value) {
        PlayerJniJNI.offline_sync_quality_t_value_set(this.swigCPtr, this, offline_sync_quality_t_value.swigValue());
    }
    ...
    public offline_sync_quality_t(offline_sync_quality_t_value offline_sync_quality_t_value) {
        this(PlayerJniJNI.new_offline_sync_quality_t__SWIG_0(offline_sync_quality_t_value.swigValue()), true);
    }
