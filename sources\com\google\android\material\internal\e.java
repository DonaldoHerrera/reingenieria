...
public final class e {
    ...
    private void n() {
        ...
        int a2 = C0287Zb.a(this.j, this.z ? 1 : 0);
        int i2 = a2 & 112;
        if (i2 == 48) {
        ...
        int a3 = C0287Zb.a(this.i, this.z ? 1 : 0);
        int i4 = a3 & 112;
        if (i4 == 48) {
    ...
    public void c(int i2) {
        na a2 = na.a(this.c.getContext(), i2, C1406j.TextAppearance);
        if (a2.g(C1406j.TextAppearance_android_textColor)) {
            this.m = a2.a(C1406j.TextAppearance_android_textColor);
        }
        if (a2.g(C1406j.TextAppearance_android_textSize)) {
            this.k = (float) a2.c(C1406j.TextAppearance_android_textSize, (int) this.k);
        }
        this.U = a2.d(C1406j.TextAppearance_android_shadowColor, 0);
        this.S = a2.b(C1406j.TextAppearance_android_shadowDx, 0.0f);
        this.T = a2.b(C1406j.TextAppearance_android_shadowDy, 0.0f);
        this.R = a2.b(C1406j.TextAppearance_android_shadowRadius, 0.0f);
        a2.a();
    ...
    public void b(float f2) {
        float a2 = C1598pb.a(f2, 0.0f, 1.0f);
        if (a2 != this.e) {
            this.e = a2;
            o();
        }
    ...
    private boolean b(CharSequence charSequence) {
        boolean z2 = true;
        if (C1778vc.l(this.c) != 1) {
            z2 = false;
        }
        return (z2 ? C0227Lb.d : C0227Lb.c).isRtl(charSequence, 0, charSequence.length());
    }
    ...
    public void a(int i2) {
        na a2 = na.a(this.c.getContext(), i2, C1406j.TextAppearance);
        if (a2.g(C1406j.TextAppearance_android_textColor)) {
            this.n = a2.a(C1406j.TextAppearance_android_textColor);
        }
        if (a2.g(C1406j.TextAppearance_android_textSize)) {
            this.l = (float) a2.c(C1406j.TextAppearance_android_textSize, (int) this.l);
        }
        this.Q = a2.d(C1406j.TextAppearance_android_shadowColor, 0);
        this.O = a2.b(C1406j.TextAppearance_android_shadowDx, 0.0f);
        this.P = a2.b(C1406j.TextAppearance_android_shadowDy, 0.0f);
        this.N = a2.b(C1406j.TextAppearance_android_shadowRadius, 0.0f);
        a2.a();
        if (VERSION.SDK_INT >= 16) {
            this.u = e(i2);
        }
