...
public enum C3288uF {
    ...
    private static final Map<Integer, C3288uF> B = null;
    private static final Map<String, C3288uF> C = null;
    private final int[] E;
    ...
    static {
        ...
        B = new HashMap();
        C = new HashMap();
        for (C3288uF uFVar : values()) {
            for (int valueOf : uFVar.E) {
                B.put(Integer.valueOf(valueOf), uFVar);
            }
            C.put(uFVar.name(), uFVar);
            for (String put : uFVar.F) {
                C.put(put, uFVar);
            }
        }
    }

    private C3288uF(int i) {
    ...
    private C3288uF(int i, String... strArr) {
        this.E = new int[]{i};
        this.F = strArr;
    }

    public static C3288uF a(String str) {
        return (C3288uF) C.get(str);
    }

    private C3288uF(int[] iArr, String... strArr) {
        this.E = iArr;
        this.F = strArr;
    }
}
