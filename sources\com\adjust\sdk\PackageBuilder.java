...
public class PackageBuilder {
    ...
    private Map<String, String> getAttributionParameters(String str) {
        ...
        Map imeiParameters = Reflection.getImeiParameters(this.adjustConfig.context, logger);
        ...
        addBoolean(hashMap, "attribution_deeplink", Boolean.valueOf(true));
        ...
        addBoolean(hashMap, "needs_response_details", Boolean.valueOf(true));
    ...
    private Map<String, String> getClickParameters(String str) {
        ...
        addDateInMilliseconds(hashMap, str2, this.clickTimeInMilliseconds);
    ...
    public ActivityPackage buildAttributionPackage(String str) {
        Map attributionParameters = getAttributionParameters(str);
    ...
    public ActivityPackage buildClickPackage(String str) {
        Map clickParameters = getClickParameters(str);
    ...
    public ActivityPackage buildEventPackage(AdjustEvent adjustEvent, boolean z) {
        Map eventParameters = getEventParameters(adjustEvent, z);
    ...
    public ActivityPackage buildGdprPackage() {
        Map gdprParameters = getGdprParameters();
    ...
    public ActivityPackage buildInfoPackage(String str) {
        Map infoParameters = getInfoParameters(str);
    ...
    public ActivityPackage buildSessionPackage(boolean z) {
        Map sessionParameters2 = getSessionParameters(z);
