...
public class PagerTitleStrip extends ViewGroup {
    private static final int[] a = {16842804, 16842901, 16842904, 16842927};
    private static final int[] b = {16843660};
    ViewPager c;
    TextView d;
    TextView e;
    TextView f;
    ...
    private class a extends DataSetObserver implements e, d {
        private int a;
    ...
    public void onAttachedToWindow() {
        ...
        if (parent instanceof ViewPager) {
            ...
            viewPager.c((e) this.m);
            viewPager.a((d) this.m);
            this.c = viewPager;
    ...
    public void a(int i2, a aVar) {
        ...
        this.d.setText((i2 < 1 || aVar == null) ? null : aVar.c(i2 - 1));
        this.e.setText((aVar == null || i2 >= a2) ? null : aVar.c(i2));
        int i3 = i2 + 1;
        if (i3 < a2 && aVar != null) {
            charSequence = aVar.c(i3);
        }
    ...
    public void a(int i2, float f2, boolean z) {
        ...
        int max2 = Math.max(Math.max(this.d.getMeasuredHeight() + i13, this.e.getMeasuredHeight() + i14), measuredHeight);
        int i17 = this.j & 112;
        if (i17 == 16) {
