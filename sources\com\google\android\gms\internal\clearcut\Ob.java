...
interface Ob {
    ...
    void a(int i, A a) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, C0741bb bbVar) throws IOException;
    ...
    @Deprecated
    void a(int i, List<?> list, C0741bb bbVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, C0741bb bbVar) throws IOException;

    void b(int i, List<String> list) throws IOException;

    void b(int i, List<?> list, C0741bb bbVar) throws IOException;
