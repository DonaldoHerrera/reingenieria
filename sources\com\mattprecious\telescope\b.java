...
class b extends ContentProvider {
    ...
    /* renamed from: com.mattprecious.telescope.b$b reason: collision with other inner class name */
    /* compiled from: FileProvider */
    static class C0054b implements a {
        ...
        if (loadXmlMetaData != null) {
            while (true) {
                ...
                if (next == 2) {
                    ...
                    } else if ("external-app-path".equals(name)) {
