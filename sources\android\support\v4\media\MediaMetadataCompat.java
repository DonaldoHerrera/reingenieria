...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final T<String, Integer> METADATA_KEYS_TYPE = new T<>();
    ...
    static {
        T<String, Integer> t = METADATA_KEYS_TYPE;
        Integer valueOf = Integer.valueOf(1);
        t.put(METADATA_KEY_TITLE, valueOf);
        METADATA_KEYS_TYPE.put(METADATA_KEY_ARTIST, valueOf);
        T<String, Integer> t2 = METADATA_KEYS_TYPE;
        Integer valueOf2 = Integer.valueOf(0);
        t2.put(METADATA_KEY_DURATION, valueOf2);
        ...
        T<String, Integer> t3 = METADATA_KEYS_TYPE;
        Integer valueOf3 = Integer.valueOf(2);
        String str = METADATA_KEY_ART;
        t3.put(str, valueOf3);
        T<String, Integer> t4 = METADATA_KEYS_TYPE;
        String str2 = METADATA_KEY_ART_URI;
        t4.put(str2, valueOf);
        T<String, Integer> t5 = METADATA_KEYS_TYPE;
        String str3 = METADATA_KEY_ALBUM_ART;
        t5.put(str3, valueOf3);
        T<String, Integer> t6 = METADATA_KEYS_TYPE;
        String str4 = METADATA_KEY_ALBUM_ART_URI;
        t6.put(str4, valueOf);
        T<String, Integer> t7 = METADATA_KEYS_TYPE;
        Integer valueOf4 = Integer.valueOf(3);
        t7.put(METADATA_KEY_USER_RATING, valueOf4);
        ...
        T<String, Integer> t8 = METADATA_KEYS_TYPE;
        String str5 = METADATA_KEY_DISPLAY_ICON;
        t8.put(str5, valueOf3);
        T<String, Integer> t9 = METADATA_KEYS_TYPE;
