...
public class Zz extends C1592p {
    ...
    public Zz(Context context, Drawable drawable, float f2, float f3, float f4) {
        super(drawable);
        this.m = a.a(context, C1801vz.design_fab_shadow_start_color);
        this.n = a.a(context, C1801vz.design_fab_shadow_mid_color);
        this.o = a.a(context, C1801vz.design_fab_shadow_end_color);
        this.c = new Paint(5);
    ...
    private void c() {
        ...
        this.g.setFillType(FillType.EVEN_ODD);
