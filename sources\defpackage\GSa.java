...
public final class GSa<T, R> extends C6642iSa<T, R> {
    ...
    static final class a<T, R> extends AtomicInteger implements GPa<T>, VPa {
        ...
        final C7118pQa<? super T, ? extends MPa<? extends R>> f;
        ...
        /* compiled from: ObservableFlatMapSingle */
        final class C0148a extends AtomicReference<VPa> implements KPa<R>, VPa {
            C0148a() {
            }
        ...
        /* access modifiers changed from: 0000 */
        public void a(C0148a aVar, Throwable th) {
            this.c.c(aVar);
            if (this.e.a(th)) {
                if (!this.b) {
                    this.h.dispose();
    ...
    public GSa(EPa<T> ePa, C7118pQa<? super T, ? extends MPa<? extends R>> pqa, boolean z) {
        super(ePa);
        this.b = pqa;
        this.c = z;
    }
