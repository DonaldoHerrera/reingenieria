...
public class list_view_interaction_action_t {
    ...
    protected static long getCPtr(list_view_interaction_action_t list_view_interaction_action_t) {
        if (list_view_interaction_action_t == null) {
            return 0;
        }
        return list_view_interaction_action_t.swigCPtr;
    }
    ...
    public void setValue(list_view_interaction_action_t_value list_view_interaction_action_t_value) {
        PlayerJniJNI.list_view_interaction_action_t_value_set(this.swigCPtr, this, list_view_interaction_action_t_value.swigValue());
    }
    ...
    public list_view_interaction_action_t(list_view_interaction_action_t_value list_view_interaction_action_t_value) {
        this(PlayerJniJNI.new_list_view_interaction_action_t__SWIG_0(list_view_interaction_action_t_value.swigValue()), true);
    }
