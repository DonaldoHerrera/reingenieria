...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion = new int[Inclusion.values().length];
        ...
        static {
            $SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion[Inclusion.ALWAYS.ordinal()] = 1;
            $SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion[Inclusion.NON_NULL.ordinal()] = 2;
            $SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion[Inclusion.NON_DEFAULT.ordinal()] = 3;
            $SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion[Inclusion.NON_EMPTY.ordinal()] = 4;
            $SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion[Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
        }
    }
    ...
    public TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        typeResolverBuilder.inclusion(include);
            ...
            if (javaType.hasRawClass(cls)) {
                ...
                try {
                    if (cls.isAssignableFrom(rawClass)) {
                        ...
                        throw new JsonMappingException(null, String.format("Cannot refine serialization type %s into %s; types not related", new Object[]{javaType, cls.getName()}));
                    }
                } catch (IllegalArgumentException e) {
                ...
                if (keyType.hasRawClass(cls3)) {
                    ...
                    try {
                        if (cls3.isAssignableFrom(rawClass2)) {
                            ...
                            throw new JsonMappingException(null, String.format("Cannot refine serialization key type %s into %s; types not related", new Object[]{keyType, cls3.getName()}));
                        }
                    } catch (IllegalArgumentException e2) {
        ...
        if (contentType.hasRawClass(cls2)) {
            ...
            try {
                if (cls2.isAssignableFrom(rawClass3)) {
                    ...
                    throw new JsonMappingException(null, String.format("Cannot refine serialization content type %s into %s; types not related", new Object[]{contentType, cls2.getName()}));
                }
            } catch (IllegalArgumentException e3) {
