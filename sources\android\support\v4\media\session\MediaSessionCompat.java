...
public class MediaSessionCompat {
  ...
  mth insns count: 93
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setPlaybackToRemote(G g) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, g.d());
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private a mVolumeCallback = new a() {
            public void onVolumeChanged(G g) {
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                if (mediaSessionImplBase.mVolumeProvider == g) {
                    ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, g.c(), g.b(), g.a());
        ...
        class MediaSessionStub extends Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    G g = MediaSessionImplBase.this.mVolumeProvider;
                    if (i == 2) {
                        int c = g.c();
                        int b = g.b();
                        i3 = g.a();
        ...
        public void setPlaybackToRemote(G g) {
            if (g != null) {
                G g2 = this.mVolumeProvider;
                if (g2 != null) {
                    g2.a((a) null);
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = g;
                ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.c(), this.mVolumeProvider.b(), this.mVolumeProvider.a());
                sendVolumeInfoChanged(parcelableVolumeInfo);
                g.a(this.mVolumeCallback);
                return;
            }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = Stub.asInterface(f.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                f.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public void setPlaybackToRemote(G g) {
        if (g != null) {
            this.mImpl.setPlaybackToRemote(g);
            return;
        }
        throw new IllegalArgumentException("volumeProvider may not be null!");
    }
