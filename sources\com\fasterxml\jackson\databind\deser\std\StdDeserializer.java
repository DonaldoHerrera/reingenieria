...
public abstract class StdDeserializer<T> extends JsonDeserializer<T> implements Serializable {
    ...
    public boolean _parseBooleanFromInt(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        return !BuildConfig.VERSION_NAME.equals(jsonParser.getText());
    }
    ...
    public final int _parseIntPrimitive(DeserializationContext deserializationContext, String str) throws IOException {
        try {
            ...
            return _nonNullNumber((Number) deserializationContext.handleWeirdStringValue(this._valueClass, str, "Overflow: numeric value (%s) out of range of int (%d -%d)", str, Integer.valueOf(Integer.MIN_VALUE), Integer.valueOf(BaseClientBuilder.API_PRIORITY_OTHER))).intValue();
        } catch (IllegalArgumentException unused) {
