...
public final class C1687sb {
    public static final Bundle a(HVa<String, ? extends Object>... hVaArr) {
        C7471uYa.b(hVaArr, "pairs");
        Bundle bundle = new Bundle(hVaArr.length);
        for (HVa<String, ? extends Object> hVa : hVaArr) {
            String str = (String) hVa.a();
            Object b = hVa.b();
            if (b == null) {
                ...
                if (b instanceof Object[]) {
                    ...
                    if (Parcelable.class.isAssignableFrom(componentType)) {
                        if (b != null) {
                            ...
                            throw new OVa("null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                        }
                    } else if (String.class.isAssignableFrom(componentType)) {
                        if (b != null) {
                            bundle.putStringArray(str, (String[]) b);
                        } else {
                            throw new OVa("null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                        }
                    } else if (CharSequence.class.isAssignableFrom(componentType)) {
                        if (b != null) {
                            bundle.putCharSequenceArray(str, (CharSequence[]) b);
                        } else {
                            throw new OVa("null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
                        }
