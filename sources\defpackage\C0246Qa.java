    ...
    private static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next != 2 || depth2 > depth || !xmlPullParser.getName().equals("item")) {
                ...
                TypedArray a = a(resources, theme, attributeSet2, C0242Pa.ColorStateListItem);
                int color = a.getColor(C0242Pa.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (a.hasValue(C0242Pa.ColorStateListItem_android_alpha)) {
                    f = a.getFloat(C0242Pa.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(C0242Pa.ColorStateListItem_alpha)) {
                    f = a.getFloat(C0242Pa.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0218Ja.alpha)) {
                        int i5 = i3 + 1;
                ...
                iArr2 = C0262Ua.a(iArr2, i2, a(color, f));
                iArr = (int[][]) C0262Ua.a((T[]) iArr, i2, trimStateSet);
                i2++;
            }
            i = 1;
        }
