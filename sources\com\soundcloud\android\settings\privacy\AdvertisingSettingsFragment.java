...
public final class AdvertisingSettingsFragment extends UniflowBaseFragment<C5979j> implements C5981l {
    ...
    public int Vb() {
        return l.privacy_settings_advertising;
    }
    ...
    /* access modifiers changed from: protected */
    public int Qb() {
        return p.title_advertising_settings;
    }

    /* access modifiers changed from: protected */
    public C5979j Tb() {
        C4806CMa<C5979j> cMa = this.i;
        if (cMa != null) {
            Object obj = cMa.get();
    ...
    public void a(View view, Bundle bundle) {
        ...
        UPa uPa = this.l;
        VPa f = ((PrivacySettingsToggleLayout) c(i.privacy_settings_advertising_layout)).a().h(C5970a.a).f((C6776kQa<? super T>) new C5973d<Object>(new C5971b(Ua())));
        C7471uYa.a((Object) f, "privacy_settings_adverti…olicyButtonClick::onNext)");
        XUa.a(uPa, f);
        UPa uPa2 = this.l;
        VPa f2 = ((PrivacySettingsToggleLayout) c(i.privacy_settings_advertising_layout)).b().f((C6776kQa<? super T>) new C5973d<Object>(new C5972c(Va())));
        C7471uYa.a((Object) f2, "privacy_settings_adverti…ribe(optInToggle::onNext)");
        XUa.a(uPa2, f2);
    }

    /* access modifiers changed from: protected */
    public void b(C5979j jVar) {
        C7471uYa.b(jVar, "presenter");
        jVar.a();
    }

    public void a(C5982m mVar) {
        C7471uYa.b(mVar, "viewModel");
        ((PrivacySettingsToggleLayout) c(i.privacy_settings_advertising_layout)).a(new O(mVar.b(), mVar.a(), mVar.c()));
    }

    /* access modifiers changed from: protected */
    public void a(C5979j jVar) {
        C7471uYa.b(jVar, "presenter");
        jVar.a((C5981l) this);
    }
}
