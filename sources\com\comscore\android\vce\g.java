...
class g {
    ...
    public void a(WebView webView, String str) {
        if (!this.e.d() && this.e.e()) {
            ...
            Log.w("Analytics", "In order to use trackWebView please call manualTrack during application launch.");
        }
    }
        ...
        if (!this.e.d() && this.e.e()) {
            for (WebView webView : viewArr) {
                if (webView instanceof WebView) {
                    ...
                    this.d.b(str, "the view is not an instance of a WebView");
                }
            }
        } else if (!this.e.d()) {
            Log.w(str, "In order to use trackWebViewArray please call manualTrack during application launch.");
        }
    }
