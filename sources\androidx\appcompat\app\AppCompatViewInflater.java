...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new T();
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT < 15 || C1778vc.w(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1406j.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C1406j.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(C1406j.View_theme, 0);
            if (resourceId != 0) {
        ...
        obtainStyledAttributes.recycle();
        if (resourceId != 0) {
            return (!(context instanceof C1772v) || ((C1772v) context).a() != resourceId) ? new C1772v(context, resourceId) : context;
        }
        return context;
    }
