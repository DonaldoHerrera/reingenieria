...
public class AdjustFactory {
    ...
    public static IConnectionOptions getConnectionOptions() {
        IConnectionOptions iConnectionOptions = connectionOptions;
        return iConnectionOptions == null ? new ConnectionOptions() : iConnectionOptions;
    }
    ...
    public static void useTestConnectionOptions() {
        connectionOptions = new IConnectionOptions() {
            public void applyConnectionOptions(HttpsURLConnection httpsURLConnection, String str) {
                new ConnectionOptions().applyConnectionOptions(httpsURLConnection, str);
                try {
                    ...
                    instance.init(null, new TrustManager[]{new X509TrustManager() {
                        ...
                        public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
                            String str2 = "testingMode error %s";
                            ...
                            try {
                                ...
                                AdjustFactory.getLogger().error(str2, e2.getMessage());
                            }
                        }
