...
public class SdkClickHandler implements ISdkClickHandler {
    ...
    public void sendSdkClickI(ActivityPackage activityPackage) {
        ...
        if (!iActivityHandler.getActivityState().isGdprForgotten) {
            String str = (String) activityPackage.getParameters().get("source");
            boolean z = false;
            boolean z2 = str != null && str.equals("reftag");
            String str2 = (String) activityPackage.getParameters().get("raw_referrer");
            if (!z2 || new SharedPreferencesManager(iActivityHandler.getContext()).getRawReferrer(str2, activityPackage.getClickTimeInMilliseconds()) != null) {
                ...
                if (z) {
                    ...
                    str3 = (String) activityPackage.getParameters().get(Constants.REFERRER);
                } else {
                    j = -1;
                }
                ...
                sb2.append(baseUrl);
                sb2.append(activityPackage.getPath());
                try {
                    SdkClickResponseData sdkClickResponseData = (SdkClickResponseData) UtilNetworking.createPOSTHttpsURLConnection(sb2.toString(), activityPackage, this.packageQueue.size() - 1);
