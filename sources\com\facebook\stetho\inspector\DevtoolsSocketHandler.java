...
public class DevtoolsSocketHandler implements SocketLikeHandler {
    ...
    private LightHttpServer createServer() {
        ...
        String str = ChromeDevtoolsServer.PATH;
        new ChromeDiscoveryHandler(context, str).register(handlerRegistry);
        handlerRegistry.register(new ExactPathMatcher(str), new WebSocketHandler(new ChromeDevtoolsServer(this.mModules)));
