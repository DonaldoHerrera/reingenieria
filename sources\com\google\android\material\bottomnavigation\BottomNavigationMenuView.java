...
public class BottomNavigationMenuView extends ViewGroup implements w {
    ...
    private final C0251Rb<BottomNavigationItemView> j;
    private boolean k;
    private int l;
    ...
    private BottomNavigationItemView getNewItem() {
        BottomNavigationItemView bottomNavigationItemView = (BottomNavigationItemView) this.j.a();
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (!a(this.l, size2) || !this.k) {
            ...
            int i6 = this.g;
            if (childAt.getVisibility() != 8) {
                childAt.measure(MeasureSpec.makeMeasureSpec(this.f, Integer.MIN_VALUE), makeMeasureSpec);
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(MeasureSpec.makeMeasureSpec(this.x[i12], 1073741824), makeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                i11 += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i11, MeasureSpec.makeMeasureSpec(i11, 1073741824), 0), View.resolveSizeAndState(this.h, makeMeasureSpec, 0));
    }
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.j = new C0259Tb(5);
        this.n = 0;
        this.o = 0;
        Resources resources = getResources();
        this.d = resources.getDimensionPixelSize(C1831wz.design_bottom_navigation_item_max_width);
        this.e = resources.getDimensionPixelSize(C1831wz.design_bottom_navigation_item_min_width);
        this.f = resources.getDimensionPixelSize(C1831wz.design_bottom_navigation_active_item_max_width);
        this.g = resources.getDimensionPixelSize(C1831wz.design_bottom_navigation_active_item_min_width);
        this.h = resources.getDimensionPixelSize(C1831wz.design_bottom_navigation_height);
        this.s = a(16842808);
        this.c = new AutoTransition();
        this.c.b(0);
        this.c.a(115);
        this.c.a((TimeInterpolator) new C0488bd());
        this.c.a((Transition) new q());
        this.i = new b(this);
        this.x = new int[5];
    }
    ...
    public ColorStateList a(int i2) {
        ...
        return new ColorStateList(new int[][]{b, a, ViewGroup.EMPTY_STATE_SET}, new int[]{a2.getColorForState(b, defaultColor), i3, defaultColor});
    }
