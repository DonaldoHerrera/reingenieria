...
/* compiled from: SoundStreamInsertTransactionFactory */
class C5045KCa {
    private final C7054oVa<C3800jea> a;
    private final C7054oVa<C3768fea> b;
    private final C7054oVa<C6332dsa> c;

    C5045KCa(C7054oVa<C3800jea> ova, C7054oVa<C3768fea> ova2, C7054oVa<C6332dsa> ova3) {
        a(ova, 1);
        this.a = ova;
        a(ova2, 2);
        this.b = ova2;
    ...
    public C5013JCa a(Iterable<C2227PP> iterable) {
        a(iterable, 1);
        ...
        a(obj3, 4);
        return new C5013JCa(iterable2, jea, fea, (C6332dsa) obj3);
    }
