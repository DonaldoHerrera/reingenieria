...
/* compiled from: EventLoggerAnalyticsProvider */
/* synthetic */ class C1993DN {
    ...
    static {
        a[g.LIKE.ordinal()] = 1;
        a[g.UNLIKE.ordinal()] = 2;
        a[g.REPOST.ordinal()] = 3;
        a[g.UNREPOST.ordinal()] = 4;
        a[g.SHARE.ordinal()] = 5;
        a[g.FOLLOW.ordinal()] = 6;
        a[g.UNFOLLOW.ordinal()] = 7;
        a[g.PLAYER_OPEN.ordinal()] = 8;
        a[g.PLAYER_CLOSE.ordinal()] = 9;
        a[g.PLAY_QUEUE_OPEN.ordinal()] = 10;
        a[g.PLAY_QUEUE_CLOSE.ordinal()] = 11;
        a[g.COMMENTS_OPEN.ordinal()] = 12;
        a[g.COMMENT_ADD.ordinal()] = 13;
        a[g.COMMENT_DELETE.ordinal()] = 14;
        a[g.COMMENTS_AVATAR_CLICK.ordinal()] = 15;
        a[g.STREAMING_QUALITY_STANDARD_CLICK.ordinal()] = 16;
        a[g.STREAMING_QUALITY_HIGH_CLICK.ordinal()] = 17;
        a[g.SWIPE_SKIP.ordinal()] = 18;
        a[g.SYSTEM_SKIP.ordinal()] = 19;
        a[g.BUTTON_SKIP.ordinal()] = 20;
        a[g.NAVIGATION.ordinal()] = 21;
        a[g.ITEM_NAVIGATION.ordinal()] = 22;
        a[g.SHUFFLE.ordinal()] = 23;
        a[g.VIDEO_AD_FULLSCREEN.ordinal()] = 24;
        a[g.VIDEO_AD_SHRINK.ordinal()] = 25;
        a[g.VIDEO_AD_MUTE.ordinal()] = 26;
        a[g.VIDEO_AD_UNMUTE.ordinal()] = 27;
        a[g.AD_CLICKTHROUGH.ordinal()] = 28;
        a[g.SKIP_AD_CLICK.ordinal()] = 29;
        a[g.PLAY_QUEUE_SHUFFLE.ordinal()] = 30;
        a[g.PLAY_QUEUE_TRACK_REORDER.ordinal()] = 31;
        a[g.PLAY_QUEUE_TRACK_REMOVE.ordinal()] = 32;
        a[g.PLAY_QUEUE_TRACK_REMOVE_UNDO.ordinal()] = 33;
        a[g.PLAY_QUEUE_REPEAT.ordinal()] = 34;
        a[g.PLAY_NEXT.ordinal()] = 35;
        a[g.RECOMMENDED_PLAYLISTS.ordinal()] = 36;
        a[g.MORE_PLAYLISTS_BY_USER.ordinal()] = 37;
        a[g.DISCOVERY_CARD.ordinal()] = 38;
        a[g.PLAYER_INTERACTION.ordinal()] = 39;
        try {
            a[g.HEADER_PLAY_TOGGLE.ordinal()] = 40;
