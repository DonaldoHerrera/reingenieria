...
final class C0991kd extends C0965gd {
    C0991kd() {
    }
            ...
            while (r13 < i3) {
                ...
                if (C0979id.d(b2)) {
                    ...
                    while (i7 < i3) {
                        ...
                        i7++;
                        int i9 = i8 + 1;
                        C0979id.b(b3, cArr, i8);
                        i8 = i9;
                    }
                    r13 = i7;
                    i6 = i8;
                } else if (C0979id.e(b2)) {
                    if (i7 < i3) {
                        int i10 = i7 + 1;
                        int i11 = i6 + 1;
                        C0979id.b(b2, bArr[i7], cArr, i6);
                        r13 = i10;
                        i6 = i11;
                    } else {
                        throw Rb.i();
                    }
                } else if (C0979id.f(b2)) {
                    if (i7 < i3 - 1) {
                        int i12 = i7 + 1;
                        int i13 = i12 + 1;
                        int i14 = i6 + 1;
                        C0979id.b(b2, bArr[i7], bArr[i12], cArr, i6);
                        r13 = i13;
                        i6 = i14;
                    } else {
                        throw Rb.i();
                    ...
                    int i17 = i16 + 1;
                    int i18 = i6 + 1;
                    C0979id.b(b2, b4, bArr[i15], bArr[i16], cArr, i6);
                    r13 = i17;
                    i6 = i18 + 1;
                } else {
                    throw Rb.i();
