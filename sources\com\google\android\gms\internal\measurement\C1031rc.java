...
final class C1031rc {
    static String a(C1026qc qcVar, String str) {
    ...
    private static void a(C1026qc qcVar, StringBuilder sb, int i) {
        String str;
        boolean z;
        C1026qc qcVar2 = qcVar;
        StringBuilder sb2 = sb;
        int i2 = i;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet<>();
        Method[] declaredMethods = qcVar.getClass().getDeclaredMethods();
        ...
        for (String str2 : treeSet) {
            ...
            if (replaceFirst.endsWith(str4) && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals(str4)) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    a(sb2, i2, a(concat), Gb.a(method2, (Object) qcVar2, new Object[0]));
                }
            }
            String str5 = "Map";
            if (replaceFirst.endsWith(str5) && !replaceFirst.equals(str5)) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    a(sb2, i2, a(concat2), Gb.a(method3, (Object) qcVar2, new Object[0]));
                }
            }
            String str6 = "set";
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? str6.concat(valueOf5) : new String(str6))) != null) {
                ...
                if (method4 != null) {
                    Object a = Gb.a(method4, (Object) qcVar2, new Object[0]);
                    if (method5 == null) {
                        if (!(a instanceof Boolean)) {
                            if (!(a instanceof Integer)) {
                                if (!(a instanceof Float)) {
                                    if (!(a instanceof Double)) {
                                        z = a instanceof String ? a.equals(str3) : a instanceof Ya ? a.equals(Ya.a) : !(a instanceof C1026qc) ? false : false;
                                        if (z) {
                                            z2 = false;
                                        }
                                    }
                        ...
                        z2 = ((Boolean) Gb.a(method5, (Object) qcVar2, new Object[0])).booleanValue();
                    }
                    if (z2) {
        ...
        if (qcVar2 instanceof b) {
            Iterator d = ((b) qcVar2).zzaic.d();
            if (d.hasNext()) {
                ((Entry) d.next()).getKey();
                throw new NoSuchMethodError();
            }
        }
        _c _cVar = ((Gb) qcVar2).zzahz;
        if (_cVar != null) {
            _cVar.a(sb2, i2);
        }
    }
    ...
    static final void a(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(str2);
                sb.append(Tc.a(Ya.a((String) obj)));
                sb.append('\"');
            } else if (obj instanceof Ya) {
                sb.append(str2);
                sb.append(Tc.a((Ya) obj));
                sb.append('\"');
            } else {
                String str3 = "}";
                String str4 = "\n";
