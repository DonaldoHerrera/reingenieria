...
public final class zzc extends Fragment implements LifecycleFragment {
    ...
    private Map<String, LifecycleCallback> zzbf = new T();
    ...
    public static zzc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            zzc zzc2 = (zzc) fragmentActivity.getSupportFragmentManager().a(str);
            if (zzc2 == null || zzc2.isRemoving()) {
                zzc2 = new zzc();
                A a = fragmentActivity.getSupportFragmentManager().a();
                a.a((Fragment) zzc2, str);
                a.b();
            }
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        if (!this.zzbf.containsKey(str)) {
            ...
            if (this.zzbg > 0) {
                new As(Looper.getMainLooper()).post(new zzd(this, lifecycleCallback, str));
                return;
            }
            return;
        }
