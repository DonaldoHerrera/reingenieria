...
public class C0361c extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void showNow(C0370l lVar, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        A a = lVar.a();
        a.a((Fragment) this, str);
