...
final class P extends C0792t<Double> implements C0770la<Double>, RandomAccess {
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (BaseClientBuilder.API_PRIORITY_OTHER - i2 >= i) {
            ...
            System.arraycopy(p.c, 0, this.c, this.d, p.d);
            this.d = i3;
            this.modCount++;
            return true;
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.d; i2++) {
            i = (i * 31) + C0761ia.a(Double.doubleToLongBits(this.c[i2]));
        }
        return i;
    }
